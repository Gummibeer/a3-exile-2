...
_killDeathRatioControl ctrlSetStructuredText parseText (format ["<t color='#00b2cd' font='OrbitronLight' size='1.6' valign='middle' align='center' shadow='0'><br/><t font='OrbitronMedium' size='3.5' color='#ffffff'>%1%2</t><br/>HEALTH<br/><t font='OrbitronMedium' size='3.5' color='#ffffff'>%3</t><br/>K/D</t>", round ((1 - damage player) * 100), "%", _killDeathRatio]);
